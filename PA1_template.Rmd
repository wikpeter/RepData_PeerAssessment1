...
As seen from the histogram, imputing missing values has no effect on the histogram. This is because the missing values all occured on whole days and the data for those days were now imputed with average data from other days and thus the days became "average days".
...
As seen from the graphs below, on weekends the steps increase later in the morning and is spread out more evenly during the day. More steps are also beeing recorded later in the evening on weekends.
